        	...
        	<div class="container">
				...
				?>
                    ...
                    <div id="lsi-header-menus">
                        ...
                        <a id="lsi-toggleMenu" href="#"><?php echo __( 'Menu', 'katlan') ; ?><span class="menu-icon"><i class="fa fa-bars"></i></span></a>
            ...
            <div class="lsi-fp-content-h container">
            	<div class="lsi-fp-content">
                    ...
                    <div class="lsi-fp-button-h">
						<a href="<?php the_permalink(); ?>"><div class="lsi-fp-button"><?php esc_html_e('Read more', 'katlan'); ?> <i class="fa fa-arrow-right"></i></div></a>
                    </div>
            	</div>
            </div>
			<?php } ?>
					...
					<a href="<?php the_permalink(); ?>">
                    	<div class="lsi-cta-content">
                    		...
                    		<div class="lsi-cta-hover">
                                <h3><?php the_title(); ?></h3>
                                <p><?php echo wp_trim_words( get_the_content(), 20, '...' ); ?></p>
                                <h4 class="lsi-cta-more"><?php esc_html_e('Read more', 'katlan'); ?></h4>
                            </div>
                		</div>
                    </a>
                </div>
